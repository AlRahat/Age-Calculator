function calculateAge(){
    ...
    if (month<0 || month==0 && today.getDay< birthday) {
        year --;
        month +=12;
    ...
    if (!birthday || !birthmonth || !birthyear) {
        ...
        elements[0].innerHTML= "must be a valid day" 
        ...
        elements[1].innerHTML= "must be a valid month" 


    } else if( birthyear > today.getFullYear()+1){
        ...
        elements[2].innerHTML= "must be a valid year" 
